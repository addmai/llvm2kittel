...
Constraint::Constraint() : refCount(0) {}
...
ref<Constraint> True::create() { return new True(); }

Constraint::CType True::getCType() { return CTrue; }

std::string True::toString() { return "TRUE"; }

std::string True::toKittelString() {
  std::cerr << "Internal error in creation of KITTeL string (" << __FILE__
            << ":" << __LINE__ << ")!" << std::endl;
  exit(217);
}

std::string True::toCIntString() {
  std::cerr << "Internal error in creation of CInt string (" << __FILE__ << ":"
            << __LINE__ << ")!" << std::endl;
  exit(217);
}
...
std::string True::toT2String() { return "0 <= 0"; }
...
ref<Constraint> True::toDNF(EliminateClass *) { return Constraint::_true; }
...
ref<Constraint> True::eliminateNeq() { return Constraint::_true; }

ref<Constraint> True::evaluateTrivialAtoms() { return Constraint::_true; }

void True::addVariablesToSet(std::set<std::string> &res) {}

bool True::equalsInternal(ref<Constraint>) { return true; }

// False
False::False() {}

ref<Constraint> False::create() { return new False(); }

Constraint::CType False::getCType() { return CFalse; }

std::string False::toString() { return "FALSE"; }
...
std::string False::toSMTString(bool) {
  std::cerr << "Internal error in creation of SMT string (" << __FILE__ << ":"
            << __LINE__ << ")!" << std::endl;
  exit(217);
}

std::string False::toT2String() { return "1 <= 0"; }
...
ref<Constraint> False::toDNF(EliminateClass *) { return Constraint::_false; }
...
ref<Constraint> False::eliminateNeq() { return Constraint::_false; }

ref<Constraint> False::evaluateTrivialAtoms() { return Constraint::_false; }

void False::addVariablesToSet(std::set<std::string> &res) {}

bool False::equalsInternal(ref<Constraint>) { return true; }

// Nondef
Nondef::Nondef() {}

ref<Constraint> Nondef::create() { return new Nondef(); }

Constraint::CType Nondef::getCType() { return CNondef; }

std::string Nondef::toString() { return "?"; }
...
ref<Constraint> Nondef::toNNF(bool) { return this; }

ref<Constraint> Nondef::toDNF(EliminateClass *) { return this; }
...
ref<Constraint> Nondef::eliminateNeq() { return this; }

ref<Constraint> Nondef::evaluateTrivialAtoms() { return this; }

void Nondef::addVariablesToSet(std::set<std::string> &res) {}

bool Nondef::equalsInternal(ref<Constraint> c) { return this == c.get(); }
...
Atom::AType Atom::getAType() { return m_type; }

Constraint::CType Atom::getCType() { return CAtom; }
...
std::string Atom::toString() {
  ...
  res << m_lhs->toString() << ' ' << typeToString(m_type) << ' '
      << m_rhs->toString();
  return res.str();
}
...
std::string Atom::toKittelString() {
  std::ostringstream res;
  res << m_lhs->toString() << ' ' << typeToKittelString(m_type) << ' '
      << m_rhs->toString();
  return res.str();
}
...
std::string Atom::toCIntString() {
  std::ostringstream res;
  res << m_lhs->toString() << ' ' << typeToCIntString(m_type) << ' '
      << m_rhs->toString();
  return res.str();
}
...
std::string Atom::toSMTString(bool onlyLinearPart) {
  if (!onlyLinearPart || (m_lhs->isLinear() && m_rhs->isLinear())) {
    std::ostringstream res;
    res << "(assert (" << typeToCIntString(m_type) << ' '
        << m_lhs->toSMTString() << ' ' << m_rhs->toSMTString() << "))\n";
    return res.str();
  } else {
    return "";
  }
...
std::string Atom::toT2String() {
  std::ostringstream res;
  res << m_lhs->toString() << ' ' << typeToT2String(m_type) << ' '
      << m_rhs->toString();
  return res.str();
}

ref<Constraint>
Atom::instantiate(std::map<std::string, ref<Polynomial>> *bindings) {
  return create(m_lhs->instantiate(bindings), m_rhs->instantiate(bindings),
                m_type);
}
...
ref<Constraint> Atom::toDNF(EliminateClass *) { return this; }
...
ref<Constraint> Atom::evaluateTrivialAtomsInternal(ref<Polynomial> lhs,
                                                   ref<Polynomial> rhs,
                                                   AType type) {
...
bool Atom::equalsInternal(ref<Constraint> c) {
  ...
  return m_type == atom->m_type && m_lhs->equals(atom->m_lhs) &&
         m_rhs->equals(atom->m_rhs);
}

ref<Polynomial> Atom::getLeft() { return m_lhs; }

ref<Polynomial> Atom::getRight() { return m_rhs; }
...
Negation::Negation(ref<Constraint> c) : m_c(c) {}

Negation::~Negation() {}

Constraint::CType Negation::getCType() { return CNegation; }
...
ref<Constraint>
Negation::instantiate(std::map<std::string, ref<Polynomial>> *bindings) {
  return create(m_c->instantiate(bindings));
}

ref<Constraint> Negation::toNNF(bool negate) { return m_c->toNNF(!negate); }

ref<Constraint> Negation::toDNF(EliminateClass *) {
  std::cerr << "Internal error in Negation::toDNF (" << __FILE__ << ":"
            << __LINE__ << ")!" << std::endl;
  exit(77);
}
...
ref<Constraint> Negation::eliminateNeq() { return create(m_c->eliminateNeq()); }
...
Constraint::CType Operator::getCType() { return COperator; }

Operator::OType Operator::getOType() { return m_type; }
...
std::string Operator::toSMTString(bool onlyLinearPart) {
  ...
  std::ostringstream res;
  res << m_lhs->toSMTString(onlyLinearPart)
      << m_rhs->toSMTString(onlyLinearPart);
  return res.str();
}

std::string Operator::toT2String() {
  std::ostringstream res;
  res << "(" << m_lhs->toT2String() << ((m_type == And) ? ") && (" : ") || (")
      << m_rhs->toT2String() << ")";
  return res.str();
}

ref<Constraint>
Operator::instantiate(std::map<std::string, ref<Polynomial>> *bindings) {
  return create(m_lhs->instantiate(bindings), m_rhs->instantiate(bindings),
                m_type);
}
...
ref<Constraint> Operator::toNNF(bool negate) {
  ...
  if (negate) {
    if (m_type == And) {
      ...
      std::cerr << "Internal error in Operator::toNNF (" << __FILE__ << ":"
                << __LINE__ << ")!" << std::endl;
      exit(42);
    }
  }
...
ref<Constraint> Operator::toDNF(EliminateClass *elim) {
  if (m_type == Or) {
    ...
    for (std::list<ref<Constraint>>::iterator outeri = lhsdcs.begin(),
                                              outere = lhsdcs.end();
         outeri != outere; ++outeri) {
      ref<Constraint> outerdc = *outeri;
      for (std::list<ref<Constraint>>::iterator inneri = rhsdcs.begin(),
                                                innere = rhsdcs.end();
           inneri != innere; ++inneri) {
    ...
    for (std::list<ref<Constraint>>::reverse_iterator ri = combined.rbegin(),
                                                      re = combined.rend();
         ri != re; ++ri) {
    ...
    std::cerr << "Internal error in Operator::toDNF (" << __FILE__ << ":"
              << __LINE__ << ")!" << std::endl;
    exit(2107);
  }
}
...
void Operator::addDualClausesToList(std::list<ref<Constraint>> &res) {
  if (m_type == And) {
    ...
    std::cerr << "Internal error in Operator::addDualClausesToList ("
...
ref<Constraint> Operator::evaluateTrivialAtoms() {
  return create(m_lhs->evaluateTrivialAtoms(), m_rhs->evaluateTrivialAtoms(),
                m_type);
}
...
ref<Constraint> Operator::getLeft() { return m_lhs; }

ref<Constraint> Operator::getRight() { return m_rhs; }

bool Operator::equalsInternal(ref<Constraint> c) {
  ref<Operator> op = static_cast<Operator *>(c.get());
  return m_type == op->m_type && m_lhs->equals(op->m_lhs) &&
         m_rhs->equals(op->m_rhs);
}
