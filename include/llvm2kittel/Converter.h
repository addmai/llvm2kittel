...
public:
  //<Negar>
  // Converter(const llvm::Type *boolType, bool assumeIsControl, bool
  ...
  // divisionConstraintType, bool bitwiseConditions, bool complexityTuples,
  // const bool t2Output);
  Converter(const llvm::Type *boolType, bool assumeIsControl,
...
private:
  ...
  std::list<ref<Polynomial>> getArgsWithPhis(llvm::BasicBlock *from,
                                             llvm::BasicBlock *to);

  void visitGenericInstruction(llvm::Instruction &I,
                               std::list<ref<Polynomial>> newArgs,
                               ref<Constraint> c = Constraint::_true);
  void visitGenericInstruction(llvm::Instruction &I, ref<Polynomial> value,
                               ref<Constraint> c = Constraint::_true);
  ...
  getZappedArgs(std::set<llvm::GlobalVariable *> toZap);
  std::list<ref<Polynomial>>
  getZappedArgs(std::set<llvm::GlobalVariable *> toZap, llvm::Value &V,
                ref<Polynomial> p);

  std::list<llvm::BasicBlock *> m_returns;
  std::map<llvm::Instruction *, unsigned int> m_idMap;
  std::map<llvm::BasicBlock *, std::list<std::pair<std::string, llvm::Value *>>>
      m_phiMap;
  ...
  ref<Constraint>
  getUnsignedComparisonForSignedBounded(llvm::CmpInst::Predicate pred,
                                        ref<Polynomial> x, ref<Polynomial> y);
  ref<Constraint>
  getSignedComparisonForUnsignedBounded(llvm::CmpInst::Predicate pred,
                                        ref<Polynomial> x, ref<Polynomial> y,
  ...
  ref<Constraint> getSDivConstraintForUnbounded(ref<Polynomial> upper,
                                                ref<Polynomial> lower,
                                                ref<Polynomial> res);
  ref<Constraint> getSDivConstraintForSignedBounded(ref<Polynomial> upper,
                                                    ref<Polynomial> lower,
                                                    ref<Polynomial> res);
  ref<Constraint> getSDivConstraintForUnsignedBounded(ref<Polynomial> upper,
                                                      ref<Polynomial> lower,
                                                      ref<Polynomial> res,
                                                      unsigned int bitwidth);
  ref<Constraint> getExactSDivConstraintForUnbounded(ref<Polynomial> upper,
                                                     ref<Polynomial> lower,
                                                     ref<Polynomial> res);

  ref<Constraint> getUDivConstraint(DivConstraintStore &store);
  ref<Constraint> getUDivConstraintForUnbounded(ref<Polynomial> upper,
                                                ref<Polynomial> lower,
                                                ref<Polynomial> res);
  ref<Constraint> getUDivConstraintForSignedBounded(ref<Polynomial> upper,
                                                    ref<Polynomial> lower,
                                                    ref<Polynomial> res);
  ref<Constraint> getUDivConstraintForUnsignedBounded(ref<Polynomial> upper,
                                                      ref<Polynomial> lower,
                                                      ref<Polynomial> res);
  ref<Constraint> getExactUDivConstraintForUnbounded(ref<Polynomial> upper,
                                                     ref<Polynomial> lower,
                                                     ref<Polynomial> res);

  ref<Constraint> getSRemConstraint(RemConstraintStore &store);
  ref<Constraint> getSRemConstraintForUnbounded(ref<Polynomial> upper,
                                                ref<Polynomial> lower,
                                                ref<Polynomial> res);
  ref<Constraint> getSRemConstraintForSignedBounded(ref<Polynomial> upper,
                                                    ref<Polynomial> lower,
                                                    ref<Polynomial> res);
  ref<Constraint> getSRemConstraintForUnsignedBounded(ref<Polynomial> upper,
                                                      ref<Polynomial> lower,
                                                      ref<Polynomial> res,
                                                      unsigned int bitwidth);

  ref<Constraint> getURemConstraint(RemConstraintStore &store);
  ref<Constraint> getURemConstraintForUnbounded(ref<Polynomial> upper,
                                                ref<Polynomial> lower,
                                                ref<Polynomial> res);
  ref<Constraint> getURemConstraintForSignedBounded(ref<Polynomial> upper,
                                                    ref<Polynomial> lower,
                                                    ref<Polynomial> res);
  ref<Constraint> getURemConstraintForUnsignedBounded(ref<Polynomial> upper,
                                                      ref<Polynomial> lower,
                                                      ref<Polynomial> res);

  ref<Constraint> getAndConstraintForBounded(ref<Polynomial> x,
                                             ref<Polynomial> y,
                                             ref<Polynomial> res);
  ref<Constraint> getOrConstraintForBounded(ref<Polynomial> x,
                                            ref<Polynomial> y,
                                            ref<Polynomial> res);
  ...
  ref<Constraint> buildConjunction(std::set<llvm::Value *> &trues,
                                   std::set<llvm::Value *> &falses);
  ref<Constraint> buildBoundConjunction(
